...
namespace Ignis {
	...
	int Render::CreateSurface(Window window, CreateGraphicPipeLineInfo graphicPipeLineInfo, CreateRenderPassInfo renderPassInfo) {
		return instance->CreateSurface(window, graphicPipeLineInfo, renderPassInfo);
	}

	void Render::Draw(int surface) {
	...
	bool Render::IsValidSurface(int surfaceIndex) {
		return instance->IsValidSurface(surfaceIndex);
	}

	int Render::AddUIElementData(UIRenderData& data) {
